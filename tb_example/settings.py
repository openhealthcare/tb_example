# Django settings for tb_example project.
import commands
import os
import sys
...
SECRET_KEY = 'mwblcg#9uw@m*m=x!nql!d(n@6=174^p1a(2#wop5-!4u59y91'
...
ROOT_URLCONF = 'tb_example.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tb_example.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('tb_example.migrations', 'tb_example.tests',
                            'tb_example.local_settings',
